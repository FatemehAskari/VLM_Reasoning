...
log_file = os.path.join(log_folder, 'render_images_counting_{}.log'.format(timestamp))
...
parser.add_argument('--task', default="counting", type=str, choices=['counting', 'counting_min_distinctiveness', 'counting_intermediate', 'counting_max_distinctiveness'],
    help="The task to render images for: counting, counting_min_distinctiveness, counting_intermediate, or counting_max_distinctiveness.")
...
if __name__ == '__main__':
    if INSIDE_BLENDER:
        ...
        print('blender --background --python counting.py -- [args]')
        print('You can also run as a standalone python script to view all arguments:')
        print('python counting.py --help')